...
user_node, project_nodes, board_nodes, card_nodes, task_nodes, software_nodes, task_triples = create_task_triples(data)
print(task_triples[0])
...
add_nodes(graph, card_nodes, labels={"card"}, keys=["name"])
